//
//  MSANotificationViewController.h
//  MySchapp
//
...
@interface MSANotificationViewController : UIViewController
@property(nonatomic,strong) NSMutableDictionary * notificationDataFromSecurity;
