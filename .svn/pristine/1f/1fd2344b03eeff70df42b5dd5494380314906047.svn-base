...
//    }
    ...
    if([self.date isDateToday]){
     //   self.dateLabelContainer.backgroundColor = (blnSelected)?kCalenderSelectedBackColor: [UIColor whiteColor];
        
     //   self.dateLabel.textColor = (blnSelected)?[UIColor whiteColor]:kCalenderSelectedBackColor;
    }else{
       // self.dateLabelContainer.backgroundColor = (blnSelected)?kCalenderSelectedBackColor: [UIColor whiteColor];
...
-(UIColor *)colorByDate
{
    return [self.date isPastDate]?[UIColor orangeColor]:[UIColor grayColor];
}
